# 1 "c:\\users\\anton\\desktop\\final_task\\scripts\\uc_signup\\\\combined_UC_SignUp.c"
...
# 1 "c:\\users\\anton\\desktop\\final_task\\scripts\\uc_signup\\\\combined_UC_SignUp.c" 2
...
# 2 "c:\\users\\anton\\desktop\\final_task\\scripts\\uc_signup\\\\combined_UC_SignUp.c" 2
...
# 3 "c:\\users\\anton\\desktop\\final_task\\scripts\\uc_signup\\\\combined_UC_SignUp.c" 2
...
# 4 "c:\\users\\anton\\desktop\\final_task\\scripts\\uc_signup\\\\combined_UC_SignUp.c" 2

# 1 "Action.c" 1
Action()
{
	lr_start_transaction("UC_SignUp");
	...
	lr_end_transaction("click_Regist",2);
	...
	web_custom_request("AccountCreateRequest", 
		...
		">{email}</email><firstName>{first_Name}</firstName><lastName>{last_Name}</lastName><loginName>{login}</loginName><password>{pass}</password><phoneNumber>{phone}</phoneNumber><stateProvince>{state}</stateProvince><zipcode>{zipcode}</zipcode></AccountCreateRequest></soap:Body></soap:Envelope>", 
		"LAST");
	...
	lr_end_transaction("click_end_regist",2);
	...
	lr_end_transaction("UC_SignUp",2);

	return 0;
}
# 5 "c:\\users\\anton\\desktop\\final_task\\scripts\\uc_signup\\\\combined_UC_SignUp.c" 2
...
# 6 "c:\\users\\anton\\desktop\\final_task\\scripts\\uc_signup\\\\combined_UC_SignUp.c" 2
